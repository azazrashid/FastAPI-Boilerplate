...
from app.core.fastapi.dependencies import AuthenticationRequired
from app.core.fastapi.dependencies.current_user import get_current_user
from app.core.fastapi.dependencies.permissions import Permissions
